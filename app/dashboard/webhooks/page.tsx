  ...
  return (
    <section className="grid gap-6 xl:grid-cols-3">
      <div className="xl:col-span-2">
        ...
        <h2 className="mt-2 text-3xl font-black text-primary">Eventos transacionais</h2>
      ...
      <EmptyState title="Logs de eventos" description="As tentativas de entrega e respostas HTTP aparecerão aqui quando o módulo estiver conectado." />
    </section>
  );
}
