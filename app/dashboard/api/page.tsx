  ...
  return (
    <section className="grid gap-6">
      <div>
        ...
        <h2 className="mt-2 text-3xl font-black text-primary dark:text-white">Chaves, documentação e testes</h2>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="p-5">
          ...
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Identificador mascarado para não expor segredo em tela.</p>
        ...
        <Card className="p-5">
          ...
          <h3 className="mt-4 font-black text-primary dark:text-white">Documentação</h3>
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Área reservada para guias de cobrança, webhooks e consulta de status.</p>
        </Card>
        <Card className="p-5">
          <TestTube2 aria-hidden="true" className="text-accent" size={24} />
          <h3 className="mt-4 font-black text-primary dark:text-white">Teste de integração</h3>
      ...
      <Table headers={["Chave", "Ambiente", "Status", "Último uso"]}>
        <tr>
          ...
          <td className="px-4 py-4 text-sm text-slate-500 dark:text-slate-400">Ainda não utilizada</td>
        </tr>
      </Table>
    </section>
  );
