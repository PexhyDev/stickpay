...
const included = [
  ...
  "Webhook incluso",
  "Painel para acompanhar transacoes",
  "Estrutura para operacao digital",
  "Mais previsibilidade financeira",
];

const comparison = [
  { market: "% + taxa fixa", stickpay: "R$ 0,40 fixo" },
  { market: "Custo variavel", stickpay: "Custo previsivel" },
  { market: "Cobranca dificil de entender", stickpay: "Cobranca transparente" },
];
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-12 items-center gap-8 px-6">
        <div className="col-span-12 md:col-span-5">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-600 dark:text-slate-300">
            Receba pagamentos Pix com custo fixo por transacao, sem porcentagem variavel e sem surpresas no fechamento.
          </p>
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            <div className="rounded-lg border border-slate-200 bg-white/80 p-4 shadow-sm backdrop-blur dark:border-slate-800 dark:bg-slate-900/80">
              ...
              <p className="mt-3 text-sm font-bold text-primary dark:text-white">Eventos incluidos</p>
            ...
            <div className="rounded-lg border border-slate-200 bg-white/80 p-4 shadow-sm backdrop-blur dark:border-slate-800 dark:bg-slate-900/80">
              ...
              <p className="mt-3 text-sm font-bold text-primary dark:text-white">Operacao clara</p>
            ...
            <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
              <div className="relative overflow-hidden rounded-lg bg-primary p-6 text-white dark:bg-slate-950">
                ...
                <p className="mt-4 text-sm leading-6 text-slate-300">
                  Cobranca clara para sua operacao, sem porcentagem escondida e sem tarifa variavel.
                </p>
              </div>
