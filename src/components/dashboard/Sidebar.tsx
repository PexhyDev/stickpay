...
const navGroups = [
  {
    ...
    items: [
      ...
      { href: "/dashboard/transacoes", label: "Transferências", icon: Send },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/api", label: "Documentação", icon: BookOpen },
    ],
  },
  {
    label: "Conta",
    items: [
      { href: "/dashboard/suporte", label: "Infrações / MED", icon: FileWarning },
...
const activeLabelsByPath: Record<string, string> = {
  ...
  "/dashboard/transacoes": "Transferências",
  "/dashboard/clientes": "Clientes",
  "/dashboard/webhooks": "Webhooks",
  "/dashboard/api": "API",
  "/dashboard/suporte": "Infrações / MED",
    ...
    <>
      ...
      >
        <div className="flex h-full min-h-0 flex-col px-5 py-5">
          <div className="flex items-center justify-between gap-3">
            <Link href="/" className="inline-flex items-center gap-3" aria-label="Voltar para landing StickPay" onClick={onClose}>
              ...
              <span>
                ...
                <span className="block text-xs font-semibold text-slate-400">Área do cliente</span>
              </span>
            </Link>
            <button
              type="button"
          ...
          <div className="mt-5 rounded-lg border border-cyan-400/15 bg-cyan-400/10 p-4 shadow-[0_14px_32px_rgba(6,182,212,0.06),inset_0_1px_0_rgba(255,255,255,0.04)]">
            ...
            <p className="mt-2 text-xs leading-5 text-slate-400">
              Operação Pix, checkout, API e movimentações em uma área focada no uso da gateway.
            </p>
